	...
	return (
		<header className="header-container">
			<div className="header-main">
				<img
					src={profilePic}
					alt="Santiago Fuentes Llanos"
					className="profile-img"
				/>
				<div className="header-text">
					<h1>Santiago Fuentes Llanos</h1>
					<p className="tagline">
						Étudiant en BUT Informatique | École 42 Paris
					</p>
					<p className="bio">
						"Développeur passionné en double cursus, maîtrisant le
						C, C++ et les environnements UNIX."
					</p>

					<div className="contact-info">
						<a href="mailto:santi.fuentes.llanos@gmail.com">
							Email
						</a>{' '}
						|<a href="https://github.com/Devilijho"> Github</a> |
						<a href="https://linkedin.com/in/santiago-fuentes-llanos-b08366283">
							{' '}
							Linkedin
						</a>{' '}
			...
			<div className="formation-section">
				...
				<div className="formation-item">
					<div className="item-header">
						<strong>
							BUT Informatique – Université Paris-Saclay (IUT
							d'Orsay)
						</strong>
				...
				<div className="formation-item">
					...
					<p>
						Formation d'excellence en informatique, basée sur le
						peer-learning
					</p>
				</div>
				...
				<div className="formation-item">
					...
					<p>
						Spécialités : Mathématiques et NSI | Lycée Émile Dubois,
						Paris
					</p>
				</div>
			</div>
